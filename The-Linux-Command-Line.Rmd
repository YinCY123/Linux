...
`tr` accepts two arguments: a set of characters to convert from and a corresponding set of charcatersto convert to.  
...
- **Tomelines** While some distributions specialize in cutting edge versions of program, many do not. This means that in order to have the very latest version of a program, compiling is necessary.  
